...
browser.find_element_by_name("email").send_keys("jacobmiller86@hotmail.com" + Keys.ENTER)
browser.find_element_by_name("password").send_keys("R0lltide17!" + Keys.ENTER)
